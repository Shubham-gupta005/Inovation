...
const lostFoundSchema = new mongoose.Schema({
    ...
    item: String,
    description: String,
    image: String, // Store the image as a base64-encoded string
});
...
app.post('/saveitem', upload.single('image'), (req, res) => {
    const { type, item, description } = req.body;
    const image = req.file ? req.file.path : null; // Assuming multer is configured to save images to a 'public/uploads' folder
